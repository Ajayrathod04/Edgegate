...
.p0-hero{
    ...
    border-radius:22px;
    background:linear-gradient(135deg,#0b1521,#101d2d);
    margin:8px 0 20px;
}
.p0-kicker{
    color:#62e6ff;
...
.p0-ok{color:#48df9b;font-weight:800}
.p0-warn{color:#ffc857;font-weight:800}
.p0-bad{color:#ff6875;font-weight:900}
.p0-decision{
    margin-top:14px;
    padding:18px;
    border-radius:18px;
...
@media(max-width:850px){
    .p0-flow{flex-direction:column}
    .p0-arrow{justify-content:center;transform:rotate(90deg)}
    .p0-title{font-size:1.8rem}
}
